...
public class Level {
  ...
  /**
   * Constructing Builder Method.
   */
  public static MedievalLevelBuilder getBuilder(int levelNumber, int roomNumber,
                                                int monsterNumber, int treasureNumber) {
    return new MedievalLevelBuilder(levelNumber, roomNumber, monsterNumber, treasureNumber);
  }
